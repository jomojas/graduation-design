...
class Generator(nn.Module):
    def __init__(self, input_channels=1, output_channels=1, base_filters=64):
        ...
        self.encoder4 = nn.Sequential(
            nn.Conv2d(
                base_filters * 4, base_filters * 8, kernel_size=4, stride=2, padding=1
            ),
        ...
        self.bottleneck = nn.Sequential(
            nn.Conv2d(
                base_filters * 8, base_filters * 16, kernel_size=4, stride=2, padding=1
            ),
        ...
        self.decoder1 = nn.Sequential(
            nn.ConvTranspose2d(
                base_filters * 16, base_filters * 8, kernel_size=4, stride=2, padding=1
            ),
            nn.BatchNorm2d(base_filters * 8),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),
        ...
        self.decoder2 = nn.Sequential(
            nn.ConvTranspose2d(
                base_filters * 16, base_filters * 4, kernel_size=4, stride=2, padding=1
            ),
            nn.BatchNorm2d(base_filters * 4),
            nn.ReLU(inplace=True),
            nn.Dropout(0.5),
        ...
        self.decoder3 = nn.Sequential(
            nn.ConvTranspose2d(
                base_filters * 8, base_filters * 2, kernel_size=4, stride=2, padding=1
            ),
            nn.BatchNorm2d(base_filters * 2),
            nn.ReLU(inplace=True),
        )
        ...
        self.decoder4 = nn.Sequential(
            nn.ConvTranspose2d(
                base_filters * 4, base_filters, kernel_size=4, stride=2, padding=1
            ),
        ...
        self.decoder5 = nn.Sequential(
            nn.ConvTranspose2d(
                base_filters * 2, output_channels, kernel_size=4, stride=2, padding=1
            ),
            nn.Tanh(),
        )
